...
class Main():
    ...
    def init_motor_control_frame(self):
        ...
        self.header_label.grid(row=7, columnspan=2)
        # self.header_label.pack()
        ...
        self.angle_label.grid(row=9, column=0)
        ...
        self.prompt_input_distance.grid(row=8, column=1)
        ...
        self.prompt_input_angle.grid(row=9, column=1)
        ...
        self.halt_button.grid(row=10, column=0)
        ...
        self.send_button.grid(row=10, column=1)
