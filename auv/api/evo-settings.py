...
# NOTE: File is run in startup.sh to initialize evo audient settings prior to starting auv up.
import usb.core
import usb.util
...
set_phantom_power(2, True)
set_phantom_power(3, True)
set_phantom_power(4, True)
